...
class signUpPinCodeVerificationScreen extends StatefulWidget {
  final String phoneNumber = "8801376221100";

  @override
  _signUpPinCodeVerificationScreenState createState() =>
      _signUpPinCodeVerificationScreenState();
}

class _signUpPinCodeVerificationScreenState
    extends State<signUpPinCodeVerificationScreen> {
  var onTapRecognizer;
